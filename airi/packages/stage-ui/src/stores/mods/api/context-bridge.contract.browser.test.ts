...
const subtitleHooks: HookCallback[] = []
...
const chatOrchestratorMock = {
  ...
  onSubtitle: (callback: HookCallback) => registerHook(subtitleHooks, callback),
  ...
  emitSubtitleHooks: (...args: unknown[]) => emitHooks(subtitleHooks, ...args),
