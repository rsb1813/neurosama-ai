...
## Neru 제품 랜딩 페이지 (2026-07-19)

- [x] 저장소 제품 맥락과 실제 Neru 자산 조사
- [x] 대상 방문자, CTA, 다국어 범위 확정
- [x] `Arcane Editorial` 시각 방향과 `Character Centerpiece` 히어로 배치 승인
- [x] 페이지 구조, 시각 체계, 구현 경계 승인
- [x] 설계 문서 작성과 자체 검토
- [x] 사용자의 작성된 설계 문서 검토
- [x] 구현 계획 작성
- [x] 테스트 우선 구현
